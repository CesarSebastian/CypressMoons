    ...
    context('Moons Quiz', () => {
      beforeEach(() => {
        ...
        cy.fixture('quiz').then(function (data) {
          this.data = data;
          cy.visit(this.data.CL_STAYING_QUIZ);
        });
      });
      ...
      it('Moons017 - Submit the quiz with All DATA', function () {
        ...
        cy.fixture('quiz').then(function (data) {
          ...
          //cy.wait(7000);
          /* We need check this code, becaus is send a error 404
      ...
      it('Moons023 - Submit the quiz with client without public key', function () {
        ...
        cy.fixture('quiz').then(function (data) {
          ...
          quizElements
            .getInputEmail()
            .type(this.data.CL_nopk_stg3, { force: true });
          quizElements
            .getInputWhatsApp()
            .type(this.data.CL_nopk_stg4, { force: true });
          quizElements.getCheckBoxPermission().check();
          quizElements.getSubmitButton().click();
          cy.contains(this.data.AnswersReview);

          //We need check this code
          //cy.wait(10000);
          //quizElements.GetPopUpDuplicatedDataNormalQuiz();
        });
      });
    ...
    context('Moons Quiz', () => {
      ...
      it('Moons020 - Submit the quiz with All DATA when opening quiz from website', function () {
        ...
        cy.fixture('quiz').then(function (data) {
          ...
          cy.visit(this.data.CL_WEBSITE_STAGING);
          ...
          quizElements
            .getInputEmail()
            .type(this.data.Cl_staging_Data_3, { force: true });
          quizElements
            .getInputWhatsApp()
            .type(this.data.Cl_staging_Data_4, { force: true });
          quizElements.getCheckBoxPermission().check();
          quizElements.getSubmitButton().click();
          cy.contains(this.data.AnswersReview);
