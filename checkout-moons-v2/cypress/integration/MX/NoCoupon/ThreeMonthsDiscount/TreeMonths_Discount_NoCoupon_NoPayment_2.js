describe.only('TreeMonths_Discount_NoCoupon_NoPayment_2',  function()
{
  beforeEach(() => 
    {
      cy
  ...
  it.only('Purchase Summary', function() {
      cy
      .VisitPage(this.env.hostMex+this.env.DiscountOnePayment);
  ...
  it.only('Shopping Address', function(){
    cy
