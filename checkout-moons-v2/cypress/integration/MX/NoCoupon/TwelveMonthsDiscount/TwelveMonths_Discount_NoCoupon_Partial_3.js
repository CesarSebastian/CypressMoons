describe.only('TwelveMonths_Discount_NoCoupon_Partial_3',  function()
{
  beforeEach(() => 
    {
      cy
    ...
    it.only('Purchase Summary', function() {
      cy
      .VisitPage(this.env.hostMex+this.env.AdvanceGreaterPaciente);
  ...
  it.only('TestToBackend', function(){
    cy.ValitadeMSI(this.data.TwelveMonths);
