describe.only('TwelveMonths_Apply_NoCoupon_Partial_4',  function()
{
  beforeEach(() => 
    {
      cy
  ...
  it.only('Purchase Summary', function() {
      cy
      .VisitPage(this.env.hostMex+this.env.testAdvancePartial);
  ...
  it.only('TestToBackend', function(){
    cy.ConvertNumber(this.data.TwelveMonths);
