    ...
    context('Moons Quiz', () => {
      beforeEach(() => {
        ...
        cy.fixture('quiz').then(function (data) {
          this.data = data;
          cy.visit(this.data.MX_DEV_QUIZ);
        });
      });
      ...
      it('Moons001 - Validate the Header', () => {
        ...
        cy.fixture('quiz').then(function (data) {
          ...
          quizElements.getMainTitleCO().should('be.visible');
      ...
      // este caso es el happy path IMPORTANTE cambiar los datos en cada prueba
      // para evitar que se muestre un error al enviar datos duplicados
      ...
      it('Moons019 - Submit the quiz with NO candidate Age', () => {
        ...
        cy.fixture('quiz').then(function (data) {
          ...
          quizElements
            .getInputName()
            .type(this.data.Answer_age1, { force: true });
          quizElements
            .getInputLastname()
            .type(this.data.Answer_age2, { force: true });
          quizElements
            .getInputEmail()
            .type(this.data.Email_age, { force: true });
          quizElements
            .getInputWhatsApp()
            .type(this.data.NumberCorrect_age, { force: true });
          quizElements.getCheckBoxPermission().check();
          quizElements.getSubmitButton().click();
          //cy.wait(5000);
      ...
      it('Moons023 - Submit the quiz with client without public key', () => {
        ...
        cy.fixture('quiz').then(function (data) {
          ...
          quizElements
            .getInputName()
            .type(this.data.MX_nopk_dev1, { force: true });
          quizElements
            .getInputLastname()
            .type(this.data.MX_nopk_dev2, { force: true });
          quizElements
            .getInputEmail()
            .type(this.data.MX_nopk_dev3, { force: true });
          quizElements
            .getInputWhatsApp()
            .type(this.data.MX_nopk_dev4, { force: true });
          quizElements.getCheckBoxPermission().check();
          quizElements.getSubmitButton().click();
          cy.contains(this.data.AnswersReview);
    ...
    context('Moons Quiz', () => {
      ...
      it('Moons020 - Submit the quiz with All DATA when opening quiz from website', () => {
        ...
        cy.fixture('quiz').then(function (data) {
          ...
          cy.visit(this.data.MX_WEBSITE_DEV);
          ...
          quizElements
            .getInputName()
            .type(this.data.MX_dev_Data_1, { force: true });
          quizElements
            .getInputLastname()
            .type(this.data.MX_dev_Data_2, { force: true });
          /*quizElements
            .getInputEmail()
            .type(this.data.Email003, { force: true });*/
          cy.emailRandom();
          ...
          //cy.wait(7000);
          cy.contains(this.data.CorrectAnswer);
          cy.contains(`${this.data.MX_dev_Data_1} ${this.data.MX_dev_Data_2}`);
          cy.go('back');
        });
      });

      //IMPORTANTE se comentan debido a que al
      //momento de crear el script solo se cuenta
      //con páginas productivas de landings ads y referidos
      /*it ('Moons021 - Submit the quiz with All DATA when
      opening quiz from landing ads', function(){
            const quizElements=new QuizElements()
            cy.fixture('quiz').then(function(data){
                this.data=data
