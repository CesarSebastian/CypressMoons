    ...
    context('Moons Quiz', () => {
      ...
      it('Moons012 - Submit the quiz with question 1,2,3 with WRONG Email', () => {
        ...
        cy.fixture('quiz').then(function (data) {
          ...
          quizElements
            .getInputEmail()
            .type('qa.test.mymoons.mx', { force: true });
          // cy.emailRandom();
      ...
      it('Moons019 - Submit the quiz with NO candidate Age', () => {
        ...
        cy.fixture('quiz').then(function (data) {
          ...
          quizElements.getCheckBoxPermission().check();
          quizElements.getSubmitButton().click();
          // We need help for this pages, because it does not work
    ...
    context('Moons Quiz', () => {
      ...
      it('Moons020 - Submit the quiz with All DATA when opening quiz from website', () => {
        ...
        cy.fixture('quiz').then(function (data) {
          ...
          quizElements
            .getInputName()
            .type(this.data.MX_pro_Data_1, { force: true });
          quizElements
            .getInputLastname()
            .type(this.data.MX_pro_Data_2, { force: true });
          // quizElements.getInputEmail().type(this.data.MX_staging_Data_3, { force: true });
          cy.emailRandom();
          // quizElements.getInputWhatsApp().type(this.data.MX_staging_Data_4, { force: true });
          cy.numberRandom();
          ...
          // cy.wait(7000);
          cy.contains(this.data.CorrectAnswer);
          cy.contains(`${this.data.MX_pro_Data_1} ${this.data.MX_pro_Data_2}`);
          cy.go('back');
        });
      });
      ...
      it('Moons021 - Submit the quiz with All DATA when opening quiz from landing ads', () => {
        ...
        cy.fixture('quiz').then(function (data) {
          ...
          cy.visit('https://welovemoons.mymoons.mx/');
          ...
          quizElements
            .getInputName()
            .type(this.data.MX_pro_ads_1, { force: true });
          quizElements
            .getInputLastname()
            .type(this.data.MX_pro_ads_2, { force: true });
          // quizElements.getInputEmail().type(this.data.MX_staging_Data_3, { force: true });
          cy.emailRandom();
          // quizElements.getInputWhatsApp().type(this.data.MX_staging_Data_4, { force: true });
          cy.numberRandom();
          ...
          // cy.wait(7000);
          cy.contains(this.data.CorrectAnswer);
          cy.contains(`${this.data.MX_pro_ads_1} ${this.data.MX_pro_ads_2}`);
          cy.go('back');
        });
      });
      ...
      it('Moons022 - Submit the quiz with All DATA when opening quiz from referral', () => {
        ...
        cy.fixture('quiz').then(function (data) {
          ...
          cy.visit('https://referidos.mymoons.mx/');
          ...
          quizElements
            .getInputName()
            .type(this.data.MX_pro_ref_1, { force: true });
          quizElements
            .getInputLastname()
            .type(this.data.MX_pro_ref_2, { force: true });
          // quizElements.getInputEmail().type(this.data.MX_staging_Data_3, { force: true });
          cy.emailRandom();
          // quizElements.getInputWhatsApp().type(this.data.MX_staging_Data_4, { force: true });
          cy.numberRandom();
          ...
          // cy.wait(7000);
          cy.contains(this.data.CorrectAnswer);
          cy.contains(`${this.data.MX_pro_ref_1} ${this.data.MX_pro_ref_2}`);
          cy.go('back');
        });
      });
    });
